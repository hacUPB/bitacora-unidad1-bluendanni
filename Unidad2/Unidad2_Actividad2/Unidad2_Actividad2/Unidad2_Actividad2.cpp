...
Podemos ver que a no cambia, mientras que b y c sí cambian.
- ¿Por qué ocurre esta diferencia?
Porque cada función recibe el dato de una forma distinta,
Por valor: recibe una copia.
Por referencia: recibe un alias de la variable original.
Por puntero: recibe la dirección de memoria de la variable original.
*/
